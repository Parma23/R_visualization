...
1.  Do 5 CodeWars problems in R. Share your solutions here:
    ...
    # Write the solution
# first floor is ground floor and the last one is not actually last one
# 1 is 0 and 13 is 12 
# replacing first floor by ground floor as American system
# replacing ground floor as floor 1 in europian system
...
solution(4)
    ...
    stairs <- function(hight){
      for (i in 1:hight){
        stairs <- paste(rep('x', i), collapse = "")
        cat(stairs, "\n")
      }
    }
    stairs(4)
...
```{r}
     ...
     address <- "7111 Tradeport Dr"


   company_details <- paste(company_name, address)
   company_details

    sprintf(" %s is located at %s", company_name, address)
```
